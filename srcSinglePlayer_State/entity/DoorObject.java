...
public class DoorObject implements Entity, Scriptable {
	...
	public DoorObject(	String id, Shape shape, float angleX, float angleY, float angleZ, 
	...
	public Object clone() {
		try {
	        ...
	        n.updateRenderState();
	        return new DoorObject(	name, (Shape)cshape.clone(), angles.x, angles.y, angles.z, 
