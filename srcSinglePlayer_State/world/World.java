...
public final class World {
	...
	/**
	 * Hard difficulty ratio.
	 */
	public static float HARD = 1f;
	
	/**
	 * Medium difficulty ratio.
	 */
	public static float MEDIUM = 0.9f;
	
	/**
	 * Easy difficulty ratio.
	 */
	public static float EASY = 0.8f;
	
	/**
	 * Current difficulty ration.
	 */
