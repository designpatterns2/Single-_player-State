...
public final class Shape_aabb implements Shape {
	...
	public Shape_aabb(JGL_3DVector position, JGL_3DVector minCorner, JGL_3DVector maxCorner) {
		...
		impact = new Trace();
		result = new JGL_3DPlane(0f, 1f, 0f);
	}
	...
	public boolean trace(Trace trace) {
		...
		if (impact.isImpact()) {
			JGL_Math.plane_translate(impact.correction, pos, result);
			return trace.setNearerImpact(result, impact.fractionImpact, impact.fractionReal);
		}
		return false;
	}
