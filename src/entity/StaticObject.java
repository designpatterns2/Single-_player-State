...
public final class StaticObject implements Entity {
	...
	public StaticObject(String id, Shape shape, float angleX, float angleY, float angleZ, Node node) {
		name = id;
	...
	public Object clone() {
		return new StaticObject(name, (Shape)cshape.clone(), angles.x, angles.y, angles.z, objNode);
