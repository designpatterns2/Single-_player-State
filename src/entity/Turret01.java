...
public final class Turret01 implements Entity, Scriptable {
	...
	public Turret01(String id, int team, float posX, float posY, float posZ, 
	...
	public void render() {
		...
		canon.setLocalRotation(qy2.multLocal(qx));
	...
	public Object clone() {
	    ...
	    return new Turret01(name, team, getPosition().x, getPosition().y, getPosition().z, 
