...
public class KeyObject implements Entity, Scriptable {
	...
	public KeyObject(String id, Shape shape, float angleX, float angleY, float angleZ, Node node, 
	...
	public Object clone() {
		try {
	        ...
	        n.updateRenderState();
	        return new KeyObject(name, (Shape)cshape.clone(), angles.x, angles.y, angles.z, n, tmini, tok, tnok);
		}
		catch(Exception ex) {
