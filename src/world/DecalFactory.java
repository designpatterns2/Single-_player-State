...
public class DecalFactory {
	...
	private static JGL_3DPlane s_p1 = new JGL_3DPlane(1f, 0f, 0f);
	...
	public static void addBloodDecal(JGL_3DVector pos) {
		...
		bloodTex[0] = Resources.getTexture("blood00");
		bloodTex[1] = Resources.getTexture("blood01");
		bloodTex[2] = Resources.getTexture("blood02");
		bloodTex[3] = Resources.getTexture("blood03");
		bloodTex[4] = Resources.getTexture("blood04");
		Texture texture = bloodTex[Math.round(JGL_Math.rnd()*4f)];
		
		List nodes = World.map.displayNodes;
