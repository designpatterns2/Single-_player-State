...
public class Player {
	...
	public static float FRUSTUM_NORMAL = 65f;
	public static float FRUSTUM_SNIPER = 20f;
	public static float FRUSTUM_CHANGE = 3f;
	public static float frustumToReach;
